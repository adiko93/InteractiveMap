...
export class AlertExample extends React.PureComponent<
...
> {
  ...
  private handleEscapeKeyChange = handleBooleanChange((canEscapeKeyCancel) =>
    this.setState({ canEscapeKeyCancel })
  );

  private handleOutsideClickChange = handleBooleanChange((click) =>
    this.setState({ canOutsideClickCancel: click })
  );

  private handleWillLoadChange = handleBooleanChange((click) =>
    this.setState({ willLoad: click })
  );
